      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <p className="text-body-brown text-sm">
            <span className="line-through text-body-brown/60">Traditional Astrologer: ₹500-1500</span>
            <span className="text-saffron font-semibold ml-4">AstroBhavishya: Starting ₹0</span>
          </p>
        </div>
        ...
        <Card variant="glass" className="p-12">
          <h3 className="text-2xl font-bold text-dark-brown mb-8 text-center">
            Frequently Asked Questions
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h4 className="text-dark-brown font-semibold mb-2">Is the free version accurate?</h4>
              <p className="text-body-brown text-sm">
            ...
            <div>
              <h4 className="text-dark-brown font-semibold mb-2">Can I cancel anytime?</h4>
              <p className="text-body-brown text-sm">
            ...
            <div>
              <h4 className="text-dark-brown font-semibold mb-2">What payment methods do you accept?</h4>
              <p className="text-body-brown text-sm">
                We accept all major credit cards, UPI, net banking, and digital wallets. Your payment is 100% secure with SSL encryption.
              </p>
            </div>
            <div>
              <h4 className="text-dark-brown font-semibold mb-2">Do you offer refunds?</h4>
              <p className="text-body-brown text-sm">
